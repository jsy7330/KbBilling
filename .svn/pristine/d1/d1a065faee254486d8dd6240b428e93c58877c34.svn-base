...
<script type="text/javascript">
	...
	function setDataUpP(){
		...
		var rowId2  = $("#distributionUnitPriceTable2").jqGrid("getGridParam", "selrow" );
		var data2 = $("#distributionUnitPriceTable2").getRowData(rowId2);
		
		$("#prcDtlSeqUpP").val(data2.prcDtlSeq);
		$("#dstrbUtPrcUpP").val(data2.dstrbUtPrc);
	...
	function checkValidationUpP(){
		...
		param.dstrbUtPrc = $("#dstrbUtPrcUpP").val();			//유통단가
		
		if(param.dstrbUtPrc == ''){
			//유통단가를 등록해 주세요.
			alert('<spring:message code="LAB.M08.LAB00095" /> <spring:message code="MSG.M08.MSG00043" />');
			return false;
		}
...
<!-- title -->
<div class="layer_top">
	<div class="title"><spring:message code="LAB.M08.LAB00097"/><!-- 유통단가수정 --></div>
...
<div class="layer_box">
	<div class="ly_btn_box">
		<div class="fl">
			<h4 class="ly_title"><spring:message code="LAB.M08.LAB00097"/><!-- 유통단가수정 --></h4>
		</div>
	</div>
	...
	<table class="writeview">
		...
		<tbody> 
			...
			<tr>
				<th><spring:message code="LAB.M08.LAB00095"/><!-- 유통단가 --><span class="dot">*</span></th>
				<td colspan="3">
					<input type="text" id="dstrbUtPrcUpP" name="dstrbUtPrcUpP" class="w170" checkbyte="12" />
				</td>
			</tr>
