		...
		$("#userGrid").jqGrid({
		    ...
		    mtype:"POST",
		   	...
		   	colModel: [ 
	   		    ...
	   		    /*{ label: '구간대정의식별자', name: 'attrCd', width: 120},			//속성 코드
	   			{ label: '구간대명', name: 'attrCd', width: 120},			//속성 코드
	   			{ label: '구간대유형', name: 'attrCd', width: 120},			//속성 코드
	   			{ label: '과금요소단위', name: 'attrCd', width: 120},*/			//속성 코드
	   			{ label: 'Tier Set Identifier', name: 'attrCd', width: 120},			//속성 코드
	   			{ label: 'Tier Set Name', name: 'attrCd', width: 120},			//속성 코드
	   			{ label: 'Tier Set Type', name: 'attrCd', width: 120},			//속성 코드
	   			{ label: 'Rating Factor Unit Code', name: 'attrCd', width: 120},
	   		],
		...
		$("#workGrpUserGrid").jqGrid({
		    ...
		    mtype:"POST",
		   	...
		   	colModel: [ 
	  	 		...
	  	 		{ label: '구간시작점', name: 'attrCd', width : 100},			//속성 코드
	  	 		{ label: '구간종료점', name: 'attrCd', width : 100},*/			//속성 코드
	   			{ label: 'Input Order', name: 'attrCd', width : 100},			//속성 코드
	  	 		{ label: 'Tier Start Point', name: 'attrCd', width : 100},			//속성 코드
	  	 		{ label: 'Tier End Point', name: 'attrCd', width : 100},
	   		],
...
<form id="attribute" name="attribute" method="post">
	...
	<div class="main_btn_box">
			<div class="fl">
				<!-- <h4 class="sub_title">구간대관리</h4>-->
				<h4 class="sub_title">Tier Set</h4>
			</div>
			<div class="fr mt10">
...
<div class="lay_box2">
	...
	<div class="lay_right2">
		<div class="main_btn_box">
			<div class="fl">
		            <!--  <h4 class="sub_title">구간 </h4>-->
		            <h4 class="sub_title">Tier Set Details </h4>
			</div>
		</div>
