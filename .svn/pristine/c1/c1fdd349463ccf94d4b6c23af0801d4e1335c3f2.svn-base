...
public class PaymentDetailVO implements Serializable,CommonVO{

	/**
	 * 
	 */
	private static final long serialVersionUID = -6103177573421199871L;
	...
	private String pmcResn; /* 납부방법변경사유 코드*/
	private String pmcResnNm; /*납부방법 변경사유*/
	private String billMdmGiroYn; /* 청구매체지로여부 */
	private String billMdmEmlYn; /* 청구매체이메일여부 */
	private String billMdmSmsYn; /* 청구매체SMS여부 */
	private String bnkCd; /* 은행코드 */
	private String bnkCdNm; /* 은행코드 */
	...
	private String billCyclCd; /*청구주기*/
	private String billCyclNm; /*청구주기명*/
	...
	private String billMdmGiroNm; /* 청구매체지로방법명 */
	private String billMdmEmlNm; /* 청구매체이메일방법명 */
	private String billMdmSmsNm; /* 청구매체SMS방법명 */
	...
	/**
	 * @return the billCyclNm
	 */
	public String getBillCyclNm() {
		return billCyclNm;
	}
	/**
	 * @param billCyclNm the billCyclNm to set
	 */
	public void setBillCyclNm(String billCyclNm) {
		this.billCyclNm = billCyclNm;
	}
	/**
	 * @return the rcptId
	 */
	...
	/**
	 * @return the billMdmGiroNm
	 */
	public String getBillMdmGiroNm() {
		return billMdmGiroNm;
	}
	/**
	 * @param billMdmGiroNm the billMdmGiroNm to set
	 */
	public void setBillMdmGiroNm(String billMdmGiroNm) {
		this.billMdmGiroNm = billMdmGiroNm;
	}
	/**
	 * @return the billMdmEmlNm
	 */
	public String getBillMdmEmlNm() {
		return billMdmEmlNm;
	}
	/**
	 * @param billMdmEmlNm the billMdmEmlNm to set
	 */
	public void setBillMdmEmlNm(String billMdmEmlNm) {
		this.billMdmEmlNm = billMdmEmlNm;
	}
	/**
	 * @return the billMdmSmsNm
	 */
	public String getBillMdmSmsNm() {
		return billMdmSmsNm;
	}
	/**
	 * @param billMdmSmsNm the billMdmSmsNm to set
	 */
	public void setBillMdmSmsNm(String billMdmSmsNm) {
		this.billMdmSmsNm = billMdmSmsNm;
	}
	/**
	 * @return the city
	 */
