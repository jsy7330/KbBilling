package com.ntels.ccbs.distribute.domain.logistics.inventoryMoveChangeMng;
...
@XStreamAlias("ProductStatusVO")
public class ProductStatusVO extends PagingValue {

	private String eqtSeq;			//단말기일련번호
	...
	private String lgstProcStatCd;	//물류처리상태코드
	private String lgstProcDttm;	//물류처리일시
	private String ownLocCd;		//소유위치코드
	...
	private String eqtStatNm;		//단말기상태코드
	
	private String itemNm;			//
	private String colorNm;			//
	private String eqtUseNm;		//상태코드명
	private String lgstProcStatNm;	//물류처리상태코드명
	private String updBfrNm;		//변경전코드명
	private String ownLocNm;		//소유위치코드명
	private String aftrUpdNm;		//변경후코드명
	private String userName;		//
	private String itemTpCd;		//
	
	private String eqtSeqStart;		//
	private String eqtSeqEnd;		//
	private String eqtStatCd2;		//
	...
	public String getEqtStatCd2() {
		return eqtStatCd2;
	}
	public void setEqtStatCd2(String eqtStatCd2) {
		this.eqtStatCd2 = eqtStatCd2;
	}
	...
	public String getLgstProcStatNm() {
		return lgstProcStatNm;
	}
	public void setLgstProcStatNm(String lgstProcStatNm) {
		this.lgstProcStatNm = lgstProcStatNm;
	}
	public String getUpdBfrNm() {
		return updBfrNm;
	}
	public void setUpdBfrNm(String updBfrNm) {
		this.updBfrNm = updBfrNm;
	}
	public String getOwnLocNm() {
		return ownLocNm;
	}
	public void setOwnLocNm(String ownLocNm) {
		this.ownLocNm = ownLocNm;
	}
	public String getAftrUpdNm() {
		return aftrUpdNm;
	}
	public void setAftrUpdNm(String aftrUpdNm) {
		this.aftrUpdNm = aftrUpdNm;
	}
	...
	public String getEqtSeqStart() {
		return eqtSeqStart;
	}
	public void setEqtSeqStart(String eqtSeqStart) {
		this.eqtSeqStart = eqtSeqStart;
	}
	public String getEqtSeqEnd() {
		return eqtSeqEnd;
	}
	public void setEqtSeqEnd(String eqtSeqEnd) {
		this.eqtSeqEnd = eqtSeqEnd;
	}
