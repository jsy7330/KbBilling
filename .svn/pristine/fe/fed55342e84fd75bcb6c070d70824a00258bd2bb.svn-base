...
public class CustInfoVO implements Serializable,CommonVO{

	
	/**
	 * 
	 */
	private static final long serialVersionUID = -3079678185052510054L;
	private String soId; /* 사업구분 */
	private String custId; /* 고객번호 */
	private String custNmAsMask; /* 고객명 */
	...
	/**
	 * @return the custNmAsMask
	 */
	public String getCustNmAsMask() {
		return custNmAsMask;
	}
	/**
	 * @param custNmAsMask the custNmAsMask to set
	 */
	public void setCustNmAsMask(String custNmAsMask) {
		this.custNmAsMask = custNmAsMask;
	}
	/**
	 * @return the custTp
	 */
	...
	public String toString() {
		...
		builder.append("CustInfoVO [soId=");
		builder.append(soId);
		builder.append(", custId=");
		builder.append(custId);
		builder.append(", custNmAsMask=");
		builder.append(custNmAsMask);
