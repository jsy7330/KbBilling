...
public class CustomerInfoVO implements Serializable,CommonVO{

	
	/**
	 * 
	 */
	private static final long serialVersionUID = 6901841169891488950L;
	private String soId; /* 사업구분 */
	private String custId; /* 고객번호 */
	private String custNm; /* 고객명 */
	private String custTp; /* 고객유형 */
	private String custTpNm; /* 고객유형명 */
	private String custCl; /* 고객구분 */
	private String custClNm; /* 고객구분명 */
	private String corpRegNoAsMask; /* 주민/법인번호 */
	private String corpRegNo; /* 주민/법인번호 */
	private String ipinNo; /* 아이핀번호 */
	private String bizRegNo; /* 사업자등록번호 */
	private String taxTp; /* 과세구분 */
	private String taxTpNm; /* 과세구분명 */
	...
	private String chngResn; /* 변경사유 */
	private String chngResnNm; /* 변경사유명 */
	private String restricPwd; /* 제한비밀번호 */
	private String repNm; /* 대표자명 */
	private String busiCndt; /* 업태 */
	private String busiCndtNm; /* 업태명 */
	private String busiTp; /* 업종 */
	private String busiTpNm; /* 업종명 */
	private String rcptId; /* 접수번호 */
	private String foreignerExpiratDt; /* 외국인체류만료일자 */
	...
	private String busiChrgNm; /*담당자*/
	private String busiChrgDuty; /*직책*/
	private String busiChrgTelno; /*담당자 전화번호*/
	...
	/**
	 * @param ipinNo the ipinNo to set
	 */
	 ...
	 * @return the taxTpNm
	 */
	public String getTaxTpNm() {
		return taxTpNm;
	}
	/**
	 * @param taxTpNm the taxTpNm to set
	 */
	public void setTaxTpNm(String taxTpNm) {
		this.taxTpNm = taxTpNm;
	}
	/**
	 * @return the authYn
	 */
	...
	/**
	 * @return the chngResnNm
	 */
	public String getChngResnNm() {
		return chngResnNm;
	}
	/**
	 * @param chngResnNm the chngResnNm to set
	 */
	public void setChngResnNm(String chngResnNm) {
		this.chngResnNm = chngResnNm;
	}
	/**
	 * @return the restricPwd
	 */
	public String getRestricPwd() {
		return restricPwd;
	}
	/**
	 * @param restricPwd the restricPwd to set
	 */
	public void setRestricPwd(String restricPwd) {
		this.restricPwd = restricPwd;
	}
	/**
	 * @return the repNm
	 */
	...
	/**
	 * @param busiCndt the busiCndt to set
	 */
	public void setBusiCndt(String busiCndt) {
		this.busiCndt = busiCndt;
	}
	/**
	 * @return the busiCndtNm
	 */
	public String getBusiCndtNm() {
		return busiCndtNm;
	}
	/**
	 * @param busiCndtNm the busiCndtNm to set
	 */
	public void setBusiCndtNm(String busiCndtNm) {
		this.busiCndtNm = busiCndtNm;
	}
	/**
	 * @return the busiTp
	 */
	...
	/**
	 * @param busiTp the busiTp to set
	 */
	...
	/**
	 * @param busiTpNm the busiTpNm to set
	 */
	...
	/**
	 * @return the foreignerExpiratDt
	 */
	public String getForeignerExpiratDt() {
		return foreignerExpiratDt;
	}
	/**
	 * @param foreignerExpiratDt the foreignerExpiratDt to set
	 */
	public void setForeignerExpiratDt(String foreignerExpiratDt) {
		this.foreignerExpiratDt = foreignerExpiratDt;
	}
	/**
	 * @return the orgId
	 */
	...
	/**
	 * @return the busiChrgNm
	 */
	public String getBusiChrgNm() {
		return busiChrgNm;
	}
	/**
	 * @param busiChrgNm the busiChrgNm to set
	 */
	public void setBusiChrgNm(String busiChrgNm) {
		this.busiChrgNm = busiChrgNm;
	}
	/**
	 * @return the busiChrgDuty
	 */
	public String getBusiChrgDuty() {
		return busiChrgDuty;
	}
	/**
	 * @param busiChrgDuty the busiChrgDuty to set
	 */
	public void setBusiChrgDuty(String busiChrgDuty) {
		this.busiChrgDuty = busiChrgDuty;
	}
	/**
	 * @return the busiChrgTelno
	 */
	public String getBusiChrgTelno() {
		return busiChrgTelno;
	}
	/**
	 * @param busiChrgTelno the busiChrgTelno to set
	 */
	public void setBusiChrgTelno(String busiChrgTelno) {
		this.busiChrgTelno = busiChrgTelno;
	}
	/**
	 * @return the city
	 */
	...
	public String toString() {
		...
		builder.append("CustomerInfoVO [soId=");
		builder.append(soId);
		...
		builder.append(custTpNm);
		builder.append(", custCl=");
		builder.append(custCl);
		builder.append(", custClNm=");
		builder.append(custClNm);
		builder.append(", corpRegNoAsMask=");
		builder.append(corpRegNoAsMask);
		builder.append(", corpRegNo=");
		builder.append(corpRegNo);
		builder.append(", ipinNo=");
		builder.append(ipinNo);
		builder.append(", bizRegNo=");
		builder.append(bizRegNo);
		builder.append(", taxTp=");
		builder.append(taxTp);
		builder.append(", taxTpNm=");
		builder.append(taxTpNm);
		builder.append(", authYn=");
		builder.append(authYn);
		...
		builder.append(chngResn);
		builder.append(", chngResnNm=");
		builder.append(chngResnNm);
		builder.append(", restricPwd=");
		builder.append(restricPwd);
		builder.append(", repNm=");
		builder.append(repNm);
		builder.append(", busiCndt=");
		builder.append(busiCndt);
		builder.append(", busiCndtNm=");
		builder.append(busiCndtNm);
		builder.append(", busiTp=");
		builder.append(busiTp);
		builder.append(", busiTpNm=");
		builder.append(busiTpNm);
		builder.append(", rcptId=");
		builder.append(rcptId);
		builder.append(", foreignerExpiratDt=");
		builder.append(foreignerExpiratDt);
