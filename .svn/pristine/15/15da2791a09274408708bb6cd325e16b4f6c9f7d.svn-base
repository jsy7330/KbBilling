...
@Service
public class OrderPrecheckC2ServiceImpl implements OrderPrecheckService{
	
	/* The attribute management. */
    private final Log logger = LogFactory.getLog(getClass());

	private static final String CHECK_CD = "C2";
	...
	public PrecheckInfoVO savePrecheckResult(OrderCommonVO orderCommonInfo,
		...
		Integer resultVal = new Integer(0);
		...
		try{
			...
			if(pymAcntList.size() != 0){
				//resultVal = interfaceService.interface_IF00000002(pymAcntList);
			}
