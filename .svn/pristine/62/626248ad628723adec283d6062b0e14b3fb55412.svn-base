...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    ...
		    { label: '에이징ID', name: 'USE_YN_NM', width : 100, align:"center", sortable:false},
			{ label: '에이징유형', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '에이징기간', name: 'CHGR_NM', width : 150, sortable:false},
		    ...
		    { label: '에이징시작일자', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '에이징종료일자', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '에이징해제일자', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '에이징해제사유', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '에이징종료여부', name: 'CHGR_NM', width : 150, sortable:false},
...
<table class="writeview">
	...
	<thead>
		<tr>
			<th>에이징해제사유</th>
			<td>
				<textarea id="rsn" name="rsn" class="w100p h70" maxlength = "1500"></textarea>
			</td>
		</tr>
	</thead>
</table>
<div class="main_btn_box">
	...
	<ntels:auth auth="${menuAuthR}">
		<a id="searchPymBtn" class="grey-btn" title='해제' href="#">해제</a>
	</ntels:auth>
	</div>
</div>
<!-- 팝업참조 -->
