...
$(document).ready(function () {
	...
	$("#custHistGrid").jqGrid({
		...
		colModel: [ 
		    ...
		    { label: '사업', name: 'custNm', width : 180, align:"left",sortable:false},
		    { label: '계좌번호', name: 'custTpNm', width : 130, align:"left",sortable:false},
		    { label: '은행명', name: 'custClNm', width : 130, align:"left",sortable:false},
		    { label: '상태', name: 'corpRegNoAsMask', width : 130, align:"left",sortable:false, formatter:corpRegNoFormatter},
			...
			<td colspan="3">
				<div class="date_box">
					<div class="inp_date w230">
						<input type="text" id="searchStatDt" name="searchStatDt"/>
					</div>
					<span class="dash">~</span>
					<div class="inp_date w230">
						<input type="text" id="searchEndDt" name="searchEndDt"/>
					</div>
				</div>
			</td>
		</tr>
