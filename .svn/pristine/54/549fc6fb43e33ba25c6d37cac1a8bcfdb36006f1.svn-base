 ...
 */
var oMessageMap = {
	'SE_EditingAreaManager.onExit' : 'This information has been changed.',
	'SE_Color.invalidColorCode' : 'Please enter a correct color code. \n\n 예) #000000, #FF0000, #FFFFFF, #ffffff, ffffff',
	'SE_Hyperlink.invalidURL' : 'The URL you entered is incorrect.',
	'SE_FindReplace.keywordMissing' : 'Please enter the words found.',
	'SE_FindReplace.keywordNotFound' : 'No words found.',
	'SE_FindReplace.replaceAllResultP1' : 'The matches are total ',
	'SE_FindReplace.replaceAllResultP2' : 'were changed',
	'SE_FindReplace.notSupportedBrowser' : 'This is a feature you can not use in your current browser.',
	'SE_FindReplace.replaceKeywordNotFound' : 'There are no words to change.',
	'SE_LineHeight.invalidLineHeight' : 'Invalid values.',
	'SE_Footnote.defaultText' : 'Please enter your details Footnotes',
	'SE.failedToLoadFlash' : 'Flash is blocked and can not use the feature.',
	'SE2M_EditingModeChanger.confirmTextMode' : 'If you switch to text mode, the contents will be retained, \n\nbut the editing effects such as fonts, and any attachments such as images will disappear. \n\nWould you like to switch?',
