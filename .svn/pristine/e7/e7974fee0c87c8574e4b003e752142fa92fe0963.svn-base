...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    ...
		    { label: '에이징유형코드', name: 'USE_YN_NM', width : 100, align:"center", sortable:false},
		    { label: '에이징유형명', name: 'CHGR_NM', width : 150, sortable:false},
			{ label: '에이징기간', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '에이징해제상태', name: 'CHGR_NM', width : 150, sortable:false},
