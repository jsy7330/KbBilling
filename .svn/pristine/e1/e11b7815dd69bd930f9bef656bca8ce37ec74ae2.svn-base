...
$(document).ready(function() {
	...
	$("#workGrpGrid2").jqGrid({
		...
		colModel: [
		    ...
		    { label: '청구년월', name: 'USE_YN_NM', width : 100, align:"center", sortable:false},
		    { label: '청구일자', name: 'CHGR_NM', width : 150, sortable:false},
			{ label: '선납적용금액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '선납할인금액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '수납여부', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '수납처리일자', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '취소여부', name: 'CHGR_NM', width : 150, sortable:false},
...
<div class="main_btn_box">
	<div class="fl">
		<h4 class="sub_title">선납청구반영내역</h4>
	</div>
</div>
<div id='gridDiv'>
