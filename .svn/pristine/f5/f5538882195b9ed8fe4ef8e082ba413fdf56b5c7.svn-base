...
/**
 * <PRE>
 * 1. ClassName: ReceiptInfoVO
 * 2. FileName : ReceiptInfoVO.java
 * 3. Package  : com.ntels.ccbs.customer.domain.contract.receipt
 * 4. Comment  : 접수처리조회 VO
 * 5. 작성자   : hyewon
 * 6. 작성일   : 2017. 3. 15. 오후 2:49:59
 * 7. 변경이력
 *     이름    :    일자       : 변경내용
 * -------------------------------------------------------
 *     hyewon :    2017. 3. 15.    : 신규개발
 * </PRE>
 */
public class ReceiptInfoVO implements Serializable,CommonVO{

	/**
	 * 
	 */
	private static final long serialVersionUID = -1342008656909310261L;
	private String soId;
	private String soNm;
	...
	private String rcptUsrId; /* 접수자ID */
	private String rcptUsrNm; /* 접수자 */
	private String rcptOrgId; /* 접수조직ID */
	private String rcptOrgNm; /* 접수조직명 */
	private String cmplUsrId; /* 완료자ID */
	private String cmplUsrNm; /* 완료자명 */
	private String cmplOrgId; /* 완료조직ID */
	private String cmplOrgNm; /* 완료조직명 */
	private String cmplDttm; /* 완료일시 */
	private String rcptDesc; /* 요청내용 */
	private String rcptId;	 /*접수ID*/
	private String condSdate; 	/*조건-접수시작일자*/
	private String condEdate; 	/*조건-접수종료작일자*/
	private String condCustId;	/*조건-고객ID*/
	private String condRcptUsrNm;	/*조건-접수자명*/
	private String condOrderTpSel;	/*조건-오더유형*/
	private String condOrderStatusSel;	/*조건-오더상태*/
	private String condCtrtId;	/*조건-계약ID*/
	
	private String menuNo1;					//1레벨 메뉴번호
	private String menuNm1;					//1레벨 메뉴명
	private String menuNo2;					//2레벨 메뉴번호
	private String menuNo3;					//3레벨 메뉴번호
	private String menuNo4;					//4레벨 메뉴번호
	private String menuNm4;					//4레벨 메뉴명
	/**
	 * @return the soId
	 */
	...
	/**
	 * @param ifSucYn the ifSucYn to set
	 */
	...
	/**
	 * @return the rcptUsrId
	 */
	public String getRcptUsrId() {
		return rcptUsrId;
	}
	/**
	 * @param rcptUsrId the rcptUsrId to set
	 */
	public void setRcptUsrId(String rcptUsrId) {
		this.rcptUsrId = rcptUsrId;
	}
	/**
	 * @return the rcptUsrNm
	 */
	public String getRcptUsrNm() {
		return rcptUsrNm;
	}
	/**
	 * @param rcptUsrNm the rcptUsrNm to set
	 */
	public void setRcptUsrNm(String rcptUsrNm) {
		this.rcptUsrNm = rcptUsrNm;
	}
	/**
	 * @return the rcptOrgId
	 */
	public String getRcptOrgId() {
		return rcptOrgId;
	}
	/**
	 * @param rcptOrgId the rcptOrgId to set
	 */
	public void setRcptOrgId(String rcptOrgId) {
		this.rcptOrgId = rcptOrgId;
	}
	/**
	 * @return the rcptOrgNm
	 */
	public String getRcptOrgNm() {
		return rcptOrgNm;
	}
	/**
	 * @param rcptOrgNm the rcptOrgNm to set
	 */
	public void setRcptOrgNm(String rcptOrgNm) {
		this.rcptOrgNm = rcptOrgNm;
	}
	/**
	 * @return the cmplUsrId
	 */
	public String getCmplUsrId() {
		return cmplUsrId;
	}
	/**
	 * @param cmplUsrId the cmplUsrId to set
	 */
	public void setCmplUsrId(String cmplUsrId) {
		this.cmplUsrId = cmplUsrId;
	}
	/**
	 * @return the cmplUsrNm
	 */
	public String getCmplUsrNm() {
		return cmplUsrNm;
	}
	/**
	 * @param cmplUsrNm the cmplUsrNm to set
	 */
	public void setCmplUsrNm(String cmplUsrNm) {
		this.cmplUsrNm = cmplUsrNm;
	}
	/**
	 * @return the cmplOrgId
	 */
	public String getCmplOrgId() {
		return cmplOrgId;
	}
	/**
	 * @param cmplOrgId the cmplOrgId to set
	 */
	public void setCmplOrgId(String cmplOrgId) {
		this.cmplOrgId = cmplOrgId;
	}
	/**
	 * @return the cmplOrgNm
	 */
	public String getCmplOrgNm() {
		return cmplOrgNm;
	}
	/**
	 * @param cmplOrgNm the cmplOrgNm to set
	 */
	public void setCmplOrgNm(String cmplOrgNm) {
		this.cmplOrgNm = cmplOrgNm;
	}
	/**
	 * @return the cmplDttm
	 */
	...
	/**
	 * @param rcptDesc the rcptDesc to set
	 */
	...
	/**
	 * @return the condSdate
	 */
	public String getCondSdate() {
		return condSdate;
	}
	/**
	 * @param condSdate the condSdate to set
	 */
	public void setCondSdate(String condSdate) {
		this.condSdate = condSdate;
	}
	/**
	 * @return the condEdate
	 */
	public String getCondEdate() {
		return condEdate;
	}
	/**
	 * @param condEdate the condEdate to set
	 */
	public void setCondEdate(String condEdate) {
		this.condEdate = condEdate;
	}
	/**
	 * @return the condCustId
	 */
	public String getCondCustId() {
		return condCustId;
	}
	/**
	 * @param condCustId the condCustId to set
	 */
	public void setCondCustId(String condCustId) {
		this.condCustId = condCustId;
	}
	/**
	 * @return the condRcptUsrNm
	 */
	public String getCondRcptUsrNm() {
		return condRcptUsrNm;
	}
	/**
	 * @param condRcptUsrNm the condRcptUsrNm to set
	 */
	public void setCondRcptUsrNm(String condRcptUsrNm) {
		this.condRcptUsrNm = condRcptUsrNm;
	}
	/**
	 * @return the condOrderTpSel
	 */
	public String getCondOrderTpSel() {
		return condOrderTpSel;
	}
	/**
	 * @param condOrderTpSel the condOrderTpSel to set
	 */
	public void setCondOrderTpSel(String condOrderTpSel) {
		this.condOrderTpSel = condOrderTpSel;
	}
	/**
	 * @return the condOrderStatusSel
	 */
	public String getCondOrderStatusSel() {
		return condOrderStatusSel;
	}
	/**
	 * @param condOrderStatusSel the condOrderStatusSel to set
	 */
	public void setCondOrderStatusSel(String condOrderStatusSel) {
		this.condOrderStatusSel = condOrderStatusSel;
	}
	/**
	 * @return the condCtrtId
	 */
	public String getCondCtrtId() {
		return condCtrtId;
	}
	/**
	 * @param condCtrtId the condCtrtId to set
	 */
	 ...
	 * @return the menuNo1
	 */
	public String getMenuNo1() {
		return menuNo1;
	}
	/**
	 * @param menuNo1 the menuNo1 to set
	 */
	public void setMenuNo1(String menuNo1) {
		this.menuNo1 = menuNo1;
	}
	/**
	 * @return the menuNm1
	 */
	...
	/**
	 * @param menuNm1 the menuNm1 to set
	 */
	 ...
	 * @return the menuNo2
	 */
	public String getMenuNo2() {
		return menuNo2;
	}
	/**
	 * @param menuNo2 the menuNo2 to set
	 */
	public void setMenuNo2(String menuNo2) {
		this.menuNo2 = menuNo2;
	}
	/**
	 * @return the menuNo3
	 */
	public String getMenuNo3() {
		return menuNo3;
	}
	/**
	 * @param menuNo3 the menuNo3 to set
	 */
	public void setMenuNo3(String menuNo3) {
		this.menuNo3 = menuNo3;
	}
	/**
	 * @return the menuNo4
	 */
	public String getMenuNo4() {
		return menuNo4;
	}
	/**
	 * @param menuNo4 the menuNo4 to set
	 */
	public void setMenuNo4(String menuNo4) {
		this.menuNo4 = menuNo4;
	}
	/**
	 * @return the menuNm4
	 */
	public String getMenuNm4() {
		return menuNm4;
	}
	/**
	 * @param menuNm4 the menuNm4 to set
	 */
	public void setMenuNm4(String menuNm4) {
		this.menuNm4 = menuNm4;
	}
	/* (non-Javadoc)
	...
	public String toString() {
		...
		builder.append("OrderInfoVO [soId=");
		builder.append(soId);
		...
		builder.append(rcptDttm);
		builder.append(", rcptUsrId=");
		builder.append(rcptUsrId);
		builder.append(", rcptUsrNm=");
		builder.append(rcptUsrNm);
		builder.append(", rcptOrgId=");
		builder.append(rcptOrgId);
		builder.append(", rcptOrgNm=");
		builder.append(rcptOrgNm);
		builder.append(", cmplUsrId=");
		builder.append(cmplUsrId);
		builder.append(", cmplUsrNm=");
		builder.append(cmplUsrNm);
		builder.append(", cmplOrgId=");
		builder.append(cmplOrgId);
		builder.append(", cmplOrgNm=");
		builder.append(cmplOrgNm);
		builder.append(", cmplDttm=");
		builder.append(cmplDttm);
		builder.append(", rcptDesc=");
		builder.append(rcptDesc);
		builder.append("]");
