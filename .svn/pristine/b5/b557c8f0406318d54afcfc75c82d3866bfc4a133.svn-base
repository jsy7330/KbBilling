...
<div class="layer_box">
	<div class="ly_btn_box">
		...
		<div class="fr mt10">
			<a href="#" id="btnApprovalHistPopup"" name="btnApprovalHistPopup"" class="grey-btn"><span class="search_icon">이력조회</span></a> 
		</div>
	</div>
	...
	<table class="writeview2">
		...
		<tr>
			...
			<td align="center"><a href="#" class="grey-btn" id="btn_search">승인</a>&nbsp;<a href="#" class="grey-btn" id="btn_search">반려</a></td>
		</tr>
		<tr>
