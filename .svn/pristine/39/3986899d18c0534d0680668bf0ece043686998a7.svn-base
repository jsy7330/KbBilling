...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    { label: '<spring:message code="LAB.M07.LAB00004"/>', name: 'SO_ID', width : 100, align:"center", hidden:true},
		    { label: '<spring:message code="LAB.M07.LAB00026"/>', name: 'USE_YN', width : 100, align:"center", hidden:true},
		    { label: '<spring:message code="LAB.M06.LAB00139"/>', name: 'batchGroup', width : 100, align:"left", sortable:false},
		    { label: '<spring:message code="LAB.M01.LAB00220"/>', name: 'referMonthYear', width : 100, align:"center", sortable:false},
		    { label: '<spring:message code="LAB.M13.LAB00035"/>', name: 'programId', width : 200, align:"left", sortable:false},
		    { label: '<spring:message code="LAB.M13.LAB00022"/>', name: 'programName', width : 100, align:"center", sortable:false},
		    { label: '<spring:message code="LAB.M09.LAB00018"/>', name: 'workStatus', width : 150, sortable:false},
		    { label: '<spring:message code="LAB.M08.LAB00197"/>', name: 'readCount', width : 150, sortable:false},
			{ label: '<spring:message code="LAB.M10.LAB00097"/>', name: 'handlingCount', width : 150, sortable:false},
		    { label: '<spring:message code="LAB.M09.LAB00020"/>', name: 'workStartDate', width : 150, sortable:false},
			{ label: '<spring:message code="LAB.M09.LAB00034"/>', name: 'workEndDate', width : 150, sortable:false}
		],
		viewrecords: true,
		shrinkToFit:false,
		height: 120,
...
<table class="writeview">
	...
	<thead>
		...
		<tr>
			<th><spring:message code="LAB.M01.LAB00220"/></th>
			<td>
				<div class="date_box">
		...
		<tr>
			<th><spring:message code="LAB.M09.LAB00018"/></th>
			<td>
				<select id="condSo" class="w100p">
					<option value="SEL"><spring:message code="LAB.M15.LAB00002"/></option>
					<c:forEach items="${batchJopStat}" var="batchJopStat" varStatus="status">
						<option value="${batchJopStat.commonCd}">${batchJopStat.commonCdNm}</option>
					</c:forEach>
				</select>
			</td>
			<th><spring:message code="LAB.M06.LAB00139"/></th>
			<td>
				<select id="condSo" class="w100p">
					<option value="SEL"><spring:message code="LAB.M15.LAB00002"/></option>
...
<div class="main_btn_box">
	<div class="fl">
		<h4 class="sub_title"><spring:message code="LAB.M06.LAB00130"/></h4>
	</div>
</div>
<div id='gridDiv'>
