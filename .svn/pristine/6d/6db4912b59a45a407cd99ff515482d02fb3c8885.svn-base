...
/**
 * <PRE>
 * 1. ClassName: OrderProcessI208ServiceImpl
 * 2. FileName : OrderProcessI208ServiceImpl.java
 * 3. Package  : com.ntels.ccbs.customer.service.contract.contract.order
 * 4. Comment  : IOT 납부자 변경 서비스
 * 5. 작성자   : JHYun
 ...
 */
@Service
public class OrderProcessI208ServiceImpl extends OrderProcessServiceImpl implements OrderProcessService{
    private final Log logger = LogFactory.getLog(getClass());

    private static final String[] SVC_CD = {"SV096"}; //IOT 서비스
	private static final String ORDER_TP = "208"; //오더유형
	...
	public OrderRequestInfoVO createOrder(OrderRequestInfoVO orderInfo)
		...
		logger.debug("########## IOT 208 Create Order START ###########");
		...
		logger.debug("########## IOT 208 Create Order End ###########");
	...
	public OrderRequestInfoVO cancelOrder(OrderRequestInfoVO orderInfo)
		...
		logger.debug("########## IOT 208 Cancel Order START ###########");
		...
		logger.debug("########## IOT 208 Cancel Order END ###########");
	...
	public OrderRequestInfoVO saveOrder(OrderRequestInfoVO orderInfo)
		...
		logger.debug("########## IOT 208 Save Order START ###########");
		...
		logger.debug("########## IOT 208 Save Order END ###########");
		return orderInfo;
	}
	...
	public OrderRequestInfoVO progressOrder(OrderRequestInfoVO orderInfo) throws ServiceException {
		...
		logger.debug("########## IOT 208 Progress Order START ###########");
		...
		logger.debug("########## IOT 208 Progress Order END ###########");
		return orderInfo;
	}
	...
	public void processPreOrderMake(OrderRequestInfoVO orderInfo) throws ServiceException {
		...
		if(StringUtils.isEmpty(orderInfo.getPymAcntId())){
			String[] arg = {MessageUtil.getMessage("LAB.M02.LAB00006")}; //납부계정
