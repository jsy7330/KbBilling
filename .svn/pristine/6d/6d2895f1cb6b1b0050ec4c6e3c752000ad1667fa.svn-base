...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    ...
		    { label: '진행상태', name: 'SO_NM', width : 100, align:"left", sortable:false},	    			
		    { label: '조정구분', name: 'SVC_WRK_GRP_ID', width : 100, align:"center", sortable:false},
		    { label: '조정전처구금액', name: 'SVC_WRK_GRP_NM', width : 200, align:"left", sortable:false},
		    ...
		    { label: '신청번호', name: 'CHGR_NM', width : 150, sortable:false},
