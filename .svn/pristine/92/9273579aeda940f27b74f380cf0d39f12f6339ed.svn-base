...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    ...
		    { label: '사용자ID',name: 'USE_YN', width : 100, align:"center", sortable:false},
		    { label: '사용자ID', name: 'SVC_WRK_GRP_ID', width : 100, align:"center", sortable:false}
