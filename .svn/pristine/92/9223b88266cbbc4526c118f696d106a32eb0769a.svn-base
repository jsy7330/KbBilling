...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    ...
		    { label: '회선번호', name: 'CHGR_NM', width : 150, sortable:false},
		    ...
		    { label: '연체경과월수', name: 'CHGR_NM', width : 150, sortable:false},
	...
	$("#workGrpGrid1").jqGrid({
		...
		colModel: [
		    ...
		    { label: '요금항목명', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '연체개월수', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '청구금액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '수납금액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '연체금액', name: 'CHGR_NM', width : 150, sortable:false}
		],
