 ...
 * 
 * <PRE>
 * 1. ClassName: HeaderManipulationWrapper
 * 2. FileName : HeaderManipulationWrapper.java
 * 3. Package  : com.ntels.ccbs.common.filter
 * 4. Comment  :
 * 5. 작성자   : kgw
 * 6. 작성일   : 2015. 10. 22. 오후 2:44:06
 * 7. 변경이력
 *     이름    :    일자       : 변경내용
 * -------------------------------------------------------
 *     kgw :    2015. 10. 22.    : 신규개발
...
public final class HeaderManipulationWrapper extends HttpServletRequestWrapper {
	private static Logger logger = LoggerFactory.getLogger(HeaderManipulationWrapper.class);
	/**
	 *
	 * 생성자
	 *
	...
	private String clean(String value) {
		...
		logger.debug("Out clean CrossScriptingWrapper ........ value ....... {}", value);
		return value;
	}
}