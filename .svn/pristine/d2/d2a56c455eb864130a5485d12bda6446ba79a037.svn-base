...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    ...
		    { label: '번호', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '번호상태', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '번호등급', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '번호용도', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '예약ID', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '에이징ID', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '변경업무구분', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '매개번호여부', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '번호이동여부', name: 'CHGR_NM', width : 150, sortable:false},
...
<div class="main_btn_box">
	...
	<ntels:auth auth="${menuAuthR}">
		<a id="searchPymBtn" class="grey-btn" title='번호자원할당' href="#">번호자원할당</a>
		<a id='custInfoHistBtn' class="grey-btn" title='번호자원등록' href="#">번호자원등록</a>
		<a id='custInfoHistBtn' class="grey-btn" title='용도/상태변경' href="#">용도/상태변경</a>
	</ntels:auth>
	</div>
</div>
<!-- 팝업참조 -->
