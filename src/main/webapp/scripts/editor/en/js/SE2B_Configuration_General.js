...
nhn.husky.SE2M_Configuration.SE2M_ReEditAction = {
	...
	aReEditGuideMsg : [
	    'The image file size control during single click, double click, you can re-edit this.',
	    'Double attachments and re-editing can be cyclic.',
	    'When dragging the accompanying text Form Tables and re-editable.',
	    'Display and drag the attached table, re-editable.'
	]
};
