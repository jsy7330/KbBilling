...
function goInsert() {
	...
	$("#attribute").attr("action", "/product/refInfo/commonInfo/attribute/attributeInsertAction");
	$("#attribute").attr("method", "post");
	$("#attribute").submit();
}
...
//	$('input:radio[name=mstrFl]:input[value="00"]').attr("checked", true); //radio button
	$("[name=ifSys] > option[value='00']").attr("selected", "true");   //select box
...
<form:form method="post" action="/product/refInfo/commonInfo/attribute/attribute/attributeInsertAction" name="attribute" commandName="attribute">
...
<div id="mask"></div> 
	<div class="right">
		...
		<div class="main_btn_box">
			<div class="fr">
				<a class="white-btn" href="javascript:init();"><span class="re_icon"><span class="write_icon"><spring:message code="LAB.M10.LAB00050"/></span></a>
				<a class="white-btn" href="#" id="btn_insert"><span class="write_icon"><spring:message code="LAB.M09.LAB00048"/></span></a>
