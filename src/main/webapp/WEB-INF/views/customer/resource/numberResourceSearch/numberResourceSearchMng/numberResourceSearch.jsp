...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    ...
		    { label: '서비스종류', name: 'USE_YN_NM', width : 100, align:"center", sortable:false},
		    { label: '국번', name: 'CHGR_NM', width : 150, sortable:false},
			{ label: '미사용', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '사용', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '예약', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '에이징', name: 'CHGR_NM', width : 150, sortable:false}
		],
		viewrecords: true,
		shrinkToFit:false,
		height: 120,
	...
	$("#workGrpGrid1").jqGrid({
		...
		colModel: [
		    ...
		    { label: '국번등급', name: 'CHGR_NM', width : 150, sortable:false},
