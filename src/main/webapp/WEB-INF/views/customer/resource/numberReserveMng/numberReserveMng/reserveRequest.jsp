...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    ...
		    { label: '예약ID', name: 'USE_YN_NM', width : 100, align:"center", sortable:false},
		    { label: '예약신청일', name: 'CHGR_NM', width : 150, sortable:false},
			{ label: '예약유형', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '예약상태', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '서비스종류', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '국번', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '시작번호', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '마지막번호', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '예약완료여부', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '예약완료일자', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '예약시작일', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '예약종료일', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '예약기간연장일', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '예약기간연장횟수', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '예약자', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '예약취소일자', name: 'CHGR_NM', width : 150, sortable:false},
...
<div class="main_btn_box">
	<div class="fl">
		<h4 class="sub_title">번호예약신청내역</h4>
	</div>
</div>
<div id='gridDiv'>
...
<div class="main_btn_box">
	...
	<ntels:auth auth="${menuAuthR}">
		<a id="searchPymBtn" class="grey-btn" title='번호자원할당' href="#">예약완료</a>
		<a id='custInfoHistBtn' class="grey-btn" title='번호자원등록' href="#">예약취소</a>
		<a id='custInfoHistBtn' class="grey-btn" title='용도/상태변경' href="#">예약연장</a>
	</ntels:auth>
	</div>
