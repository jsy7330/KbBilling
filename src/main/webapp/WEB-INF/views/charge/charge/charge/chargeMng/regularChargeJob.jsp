...
$(document).ready(function() {
	...
	$("#batchGrid").jqGrid({
		...
		colModel: [
		    { label: '<spring:message code="LAB.M09.LAB00017"/>', name: 'pgmNm', width : 150, align:"left", sortable:false},
		    ...
		    { label: '<spring:message code="LAB.M04.LAB00016"/>', name: 'logFileNm', width : 280, align:"center", sortable:false},
			...
			{ label: '<spring:message code="LAB.M10.LAB00097"/>', name: 'cmplCnt', width : 100, align:"right", formatter:'integer', sortable:false},
			...
			{ label: '<spring:message code="LAB.M09.LAB00231"/>', name: 'startEndTime', width : 120, align:"center",sortable:false},
