	...
	$("#newBillingInfoItemTable").jqGrid({
	    ...
	    mtype:"POST",
	   	...
	   	colModel: [ 
					...
					{ label: '<spring:message code="LAB.M03.LAB00081" />', name: 'regDate', formatter: dateFormatterUsingDateYYYYMMDDHH24MISS, width : 45, align:"center"},
					{ label: '<spring:message code="LAB.M06.LAB00062" />', name: 'chgId', width : 30, align:"center"},
					{ label: '<spring:message code="LAB.M06.LAB00061" />', name: 'chgDate', formatter: dateFormatterUsingDateYYYYMMDDHH24MISS, width : 45, align:"center"},
