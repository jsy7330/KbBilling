...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    ...
		    { label: '희망적용년월', name: 'SVC_WRK_GRP_ID', width : 100, align:"center", sortable:false},
		    { label: '신청일자',name: 'USE_YN', width : 100, align:"center", hidden:true},
		    { label: '납부계정ID', name: 'USE_YN', width : 100, align:"center", hidden:true},
		    { label: '납부자명', name: 'SO_NM', width : 100, align:"left", sortable:false},
		    { label: '신청번호', name: 'SO_NM', width : 100, align:"left", sortable:false},	    			
		    { label: '최초조정전청구금액', name: 'SVC_WRK_GRP_ID', width : 100, align:"center", sortable:false},
		    { label: '조정누적금액', name: 'SVC_WRK_GRP_NM', width : 200, align:"left", sortable:false},
		    { label: '청구금액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '조정전청구금액', name: 'USE_YN_NM', width : 100, align:"center", sortable:false},
			{ label: '신청금액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '조정금액', name: 'USE_YN_NM', width : 100, align:"center", sortable:false},
		    { label: '진행상태', name: 'USE_YN_NM', width : 100, align:"center", sortable:false},
		    { label: '신청자명', name: 'CHGR_NM', width : 150, sortable:false},
	        { label: '청구일자', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '납기마감일자', name: 'CHGR_NM', width : 150, sortable:false},
   		    { label: '청구반영일자', name: 'USE_YN_NM', width : 100, align:"center", sortable:false},
