...
$(document).ready(function() {
    ...
    $("#afterAdjRegiditTable").jqGrid({
        ...
        colModel: [
            ...
            { label: '<spring:message code="LAB.M08.LAB00058" />', name: 'chrgItmNm', width : 120, align:"right"},
            { label: '<spring:message code="LAB.M07.LAB00018" />', name: 'usgCnt', formatter:'integer', width : 120, align:"right"},
            { label: '<spring:message code="LAB.M09.LAB00137" />', name: 'adjPrvBillAmt', formatter:'integer', width : 180, align:"right"},
            { label: '<spring:message code="LAB.M09.LAB00134" />', name: 'adjAmt', formatter:'integer', width : 120, align:"right"},
            { label: '<spring:message code="LAB.M05.LAB00048" />', name: 'unpayAmt', formatter:'integer', width : 100, align:"right"},
            { label: '<spring:message code="LAB.M10.LAB00031" />', name: 'adjAftBillAmt', formatter:'integer', width : 90, align:"right"},
            { label: '<spring:message code="LAB.M09.LAB00050" />', name: 'adjApplAmt', formatter:"integer", width : 180, align:"right", editable:true
