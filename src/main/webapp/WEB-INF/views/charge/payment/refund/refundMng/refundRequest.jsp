...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    ...
		    { label: '구분', name: 'SO_NM', width : 100, align:"left", sortable:false},
		    { label: '발생일련번호', name: 'SVC_WRK_GRP_ID', width : 100, align:"center", sortable:false},
		    { label: '발생구분', name: 'SVC_WRK_GRP_NM', width : 200, align:"left", sortable:false},
		    { label: '납부계정ID', name: 'USE_YN_NM', width : 100, align:"center", sortable:false},
		    { label: '납부계정명', name: 'CHGR_NM', width : 150, sortable:false},
			{ label: '적요', name: 'CHGR_NM', width : 150, sortable:false},
		    ...
		    { label: '수납기관', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '입금계좌', name: 'CHGR_NM', width : 150, sortable:false},
		    ...
		    { label: '발생구분코드', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '처리상태코드', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '입금구분코드', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '발생사유코드', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '수납기관코드', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '등록자ID', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '최종수정자ID', name: 'CHGR_NM', width : 150, sortable:false}
		],
		viewrecords: true,
		shrinkToFit:false,
		height: 120,
...
<div class="main_btn_box">
	<div class="fl">
		<h4 class="sub_title">환불신청내역등록</h4>
	</div>
</div>
<div id="regInfo">
	<table class="writeview">
		...
		<tbody>
			<tr>
				...
				<th>신청자명<span class="dot">*</span></th>
				<td>				
					<div class="inp_date w280">
						<input id="serviceNo" type="text" class="w245" disabled/>
					</div>
				</td>
				<th>환불사유<span class="dot">*</span></th>
				<td>				
				<select id="condSo" class="w100p">
					<option value="SEL"><spring:message code="LAB.M15.LAB00002"/></option>
				</select>
			...
			<tr>
				<th>환불가능금액<span class="dot">*</span></th>
				<td>				
					<div class="inp_date w280">
						<input id="serviceNo" type="text" class="w245" disabled/>
					</div>
				...
				<th>납입자와의관계<span class="dot">*</span></th>
				<td>				
				<select id="condSo" class="w100p">
					<option value="SEL"><spring:message code="LAB.M15.LAB00002"/></option>
				</select>
			...
			<tr>
				<th>환불요청금액<span class="dot">*</span></th>
				<td>				
					<div class="inp_date w280">
						<input id="serviceNo" type="text" class="w245" disabled/>
					</div>
				...
				<th>신청일시<span class="dot">*</span></th>
				<td>				
					<div class="date_box">
						<div class="inp_date w130">
							<input type="text" id="searchStatDt" name="searchStatDt"  class="datepicker" readonly="readonly" />
