...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    ...
		    { label: '발생일시', name: 'USE_YN_NM', width : 100, align:"center", sortable:false},
		    ...
		    { label: '대체구분', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '대체처리금액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '잔액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '총대체금액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '현재잔액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '대체처리일시', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '처리메모', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '발생구분', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '입금구분', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '발생사유', name: 'CHGR_NM', width : 150, sortable:false},
	...
	$("#workGrpGrid2").jqGrid({
		...
		colModel: [
		    ...
		    { label: '', name: '', width : 100, align:"center", sortable:false},
		    { label: '', name: '', width : 150, sortable:false},
			{ label: '', name: '', width : 150, sortable:false},
		    { label: '', name: '', width : 150, sortable:false},
		    { label: '', name: '', width : 150, sortable:false},
		    { label: '', name: '', width : 150, sortable:false}
...
<div class="main_btn_box">
	<div class="fl">
		<h4 class="sub_title">선수금대체상세내역</h4>
	</div>
	<div class="fr mt10">
		<a id='disableMaskBtn' class="grey-btn" href="#" title='파일다운로드'>파일다운로드</a>
	</div>
