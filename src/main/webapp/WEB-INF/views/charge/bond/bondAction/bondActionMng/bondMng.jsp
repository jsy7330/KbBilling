...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    ...
		    { label: '계약ID', name: 'USE_YN_NM', width : 100, align:"center", sortable:false},
		    ...
		    { label: '현상태', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '현연체금액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '현연체개월', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '연체금액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '최초연체년월', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '납부방법', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '납부고객명', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '기본료', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '가입비', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '단말기대금', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '국내통화료', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '국제통화료', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '부가사용료', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '세금', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '기타금액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '고액대상여부', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '고객우편번호', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '고객주소1', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '고객주소2', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '고객집전화번호', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '고객이동전화번호', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '고객E-Mail', name: 'CHGR_NM', width : 150, sortable:false},
			{ label: '납부고객우편번호', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '납부고객주소1', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '납부고객주소2', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '납부고객집전화번호', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '납부고객이동전화번호', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '제외여부', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '직권변경완료여부', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '등록자ID', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '등록일시', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '처리일시', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '비고', name: 'CHGR_NM', width : 150, sortable:false}
		],
		viewrecords: true,
		shrinkToFit:false,
		height: 120,
	...
	<thead>
		<tr>
			...
			<td>
				<select id="condSo" class="w100p">
					<option value="SEL"><spring:message code="LAB.M15.LAB00002"/></option>
					<c:forEach items="${ctrtStat}" var="ctrtStat" varStatus="status">
						<option value="${ctrtStat.commonCd}">${ctrtStat.commonCdNm}</option>
					</c:forEach>
				</select>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<select id="condSo" class="w100p">
					<option value="SEL"><spring:message code="LAB.M15.LAB00002"/></option>
					<c:forEach items="${searchTp}" var="searchTp" varStatus="status">
