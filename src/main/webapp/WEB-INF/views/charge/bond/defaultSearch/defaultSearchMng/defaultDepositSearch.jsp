...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    ...
		    { label: '미납경과월수', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '미납개월수', name: 'CHGR_NM', width : 150, sortable:false},
		    ...
		    { label: '현납부금액', name: 'CHGR_NM', width : 150, sortable:false},
	...
	$("#workGrpGrid1").jqGrid({
		...
		colModel: [
		    ...
		    { label: '이체일', name: 'USE_YN_NM', width : 100, align:"center", sortable:false},
		    ...
		    { label: '불명금대상여부', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '입금취소여부', name: 'CHGR_NM', width : 150, sortable:false}
		],
		viewrecords: true,
		shrinkToFit:false,
		height: 70,
