...
<script type="text/javascript">
	...
	function checkValidationInP(){
		...
		param.dstrbUtPrc = $("#dstrbUtPrcInP").val();			//매입단가
...
<!-- title -->
<div class="layer_top">
	<div class="title"><spring:message code="LAB.M08.LAB00096"/><!-- 유통단가등록 --></div>
...
<div class="layer_box">
	<div class="ly_btn_box">
		<div class="fl">
			<h4 class="ly_title"><spring:message code="LAB.M08.LAB00096"/><!-- 유통단가등록 --></h4>
		</div>
	</div>
	...
	<table class="writeview">
		...
		<tbody> 
			...
			<tr>
				<th><spring:message code="LAB.M08.LAB00095"/><!-- 매입단가 --><span class="dot">*</span></th>
				<td colspan="3">
					<input type="text" id="dstrbUtPrcInP" name="dstrbUtPrcInP" class="w170" checkbyte="12" />
				</td>
			</tr>
