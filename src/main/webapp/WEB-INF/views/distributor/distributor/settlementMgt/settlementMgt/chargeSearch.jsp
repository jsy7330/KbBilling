...
$(document).ready(function() {
	...
	$("#workGrpGrid").jqGrid({
		...
		colModel: [
		    ...
		    { label: '수수료항목', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '대상건수', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '대상금액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '조정금액', name: 'CHGR_NM', width : 150, sortable:false},
		    { label: '확정금액', name: 'CHGR_NM', width : 150, sortable:false}
		],
		viewrecords: true,
		shrinkToFit:false,
		height: 120,
