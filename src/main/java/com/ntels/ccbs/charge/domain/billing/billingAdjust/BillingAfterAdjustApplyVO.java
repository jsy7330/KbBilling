...
public class BillingAfterAdjustApplyVO implements Serializable,CommonVO{
	...
	private String applSoId;
	private String appntNm;
	private String rcptPsnId;
	private String rcptDttm;
	private String taxBillYnThis;
	private String taxBillYnThat;
	private String adjYn;
	private Double adjPreAmt;
	private String sidx;
	private String sord;
	...
	public String getApplSoId() {
		return applSoId;
	}
	public void setApplSoId(String applSoId) {
		this.applSoId = applSoId;
	}
	...
	public String getTaxBillYnThis() {
		return taxBillYnThis;
	}
	public void setTaxBillYnThis(String taxBillYnThis) {
		this.taxBillYnThis = taxBillYnThis;
	}
	public String getTaxBillYnThat() {
		return taxBillYnThat;
	}
	public void setTaxBillYnThat(String taxBillYnThat) {
		this.taxBillYnThat = taxBillYnThat;
	}
	...
	public Double getAdjPreAmt() {
		return adjPreAmt;
	}
	public void setAdjPreAmt(Double adjPreAmt) {
		this.adjPreAmt = adjPreAmt;
	}
