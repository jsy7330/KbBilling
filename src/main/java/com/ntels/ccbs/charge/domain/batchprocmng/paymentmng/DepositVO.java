...
public class DepositVO {
	 ...
	 * 입금기준 ERP 전송 여부
	 */
	private String dpststdrErpSndYn;
	
	/**
	 * 이체기준 ERP 전송 여부
	 */
	private String trnsstdrErpSndYn;
	...
	public String getDpstOpetrId() {
		return dpstOpetrId;
	}

	public void setDpstOpetrId(String dpstOpetrId) {
		this.dpstOpetrId = dpstOpetrId;
	}
	...
	public String getDpststdrErpSndYn() {
		return dpststdrErpSndYn;
	}

	public void setDpststdrErpSndYn(String dpststdrErpSndYn) {
		this.dpststdrErpSndYn = dpststdrErpSndYn;
	}

	public String getTrnsstdrErpSndYn() {
		return trnsstdrErpSndYn;
	}

	public void setTrnsstdrErpSndYn(String trnsstdrErpSndYn) {
		this.trnsstdrErpSndYn = trnsstdrErpSndYn;
	}
	...
	public int getBddbtTgtCnt() {
		return bddbtTgtCnt;
	}

	public void setBddbtTgtCnt(int bddbtTgtCnt) {
		this.bddbtTgtCnt = bddbtTgtCnt;
	}
	...
	/*
	 * public String getTrnsDt() { // TODO Auto-generated method stub return trnsDt;
	 * }
	 */
