...
public class ReceiptVO {
	 ...
	 * 수납처리자ID
	 */
	private String rcptOpetrId;
	
	/**
	 * 대손 수납 여부
	 */
	private String bddbtRcptYn;
	...
	public String getRcptOpetrId() {
		return rcptOpetrId;
	}

	public void setRcptOpetrId(String rcptOpetrId) {
		this.rcptOpetrId = rcptOpetrId;
	}

	public String getBddbtRcptYn() {
		return bddbtRcptYn;
	}

	public void setBddbtRcptYn(String bddbtRcptYn) {
		this.bddbtRcptYn = bddbtRcptYn;
	}
