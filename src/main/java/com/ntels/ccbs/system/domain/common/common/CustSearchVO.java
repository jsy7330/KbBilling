...
public class CustSearchVO implements Serializable,CommonVO{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1021990146724222946L;
	...
	public String toString() {
		...
		builder.append("CustSearchVO [soId=");
		builder.append(soId);
		builder.append(", soNm=");
		builder.append(soNm);
