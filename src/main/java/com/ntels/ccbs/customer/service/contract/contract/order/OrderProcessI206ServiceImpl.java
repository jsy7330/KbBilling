...
/**
 * <PRE>
 * 1. ClassName: OrderProcessI206ServiceImpl
 * 2. FileName : OrderProcessI206ServiceImpl.java
 * 3. Package  : com.ntels.ccbs.customer.service.contract.contract.order
 * 4. Comment  : IOT 설치 주소 변경 서비스
 * 5. 작성자   : JHYun
 ...
 */
@Service
public class OrderProcessI206ServiceImpl extends OrderProcessServiceImpl implements OrderProcessService{
    private final Log logger = LogFactory.getLog(getClass());

    private static final String[] SVC_CD = {"SV096"}; //IOT 서비스
	private static final String ORDER_TP = "206"; //오더유형
	...
	public OrderRequestInfoVO createOrder(OrderRequestInfoVO orderInfo)
		...
		logger.debug("########## IOT 206 Create Order START ###########");
		...
		logger.debug("########## IOT 206 Create Order End ###########");
	...
	public OrderRequestInfoVO cancelOrder(OrderRequestInfoVO orderInfo)
		...
		logger.debug("########## IOT 206 Cancel Order START ###########");
		...
		logger.debug("########## IOT 206 Cancel Order END ###########");
	...
	public OrderRequestInfoVO saveOrder(OrderRequestInfoVO orderInfo)
		...
		logger.debug("########## IOT 206 Save Order START ###########");
		...
		logger.debug("########## IOT 206 Save Order END ###########");
		return orderInfo;
	}
	...
	public OrderRequestInfoVO progressOrder(OrderRequestInfoVO orderInfo) throws ServiceException {
		...
		logger.debug("########## IOT 206 Progress Order START ###########");
		...
		logger.debug("########## IOT 206 Progress Order END ###########");
		return orderInfo;
	}
	@Override
	public void processPreOrderMake(OrderRequestInfoVO orderInfo) throws ServiceException {
		...
		//설치주소체크
		if(StringUtils.isEmpty(orderInfo.getInstZipCode())){
			String[] arg = {MessageUtil.getMessage("LAB.M07.LAB00301")}; // 설치주소
			throw new ServiceException("MSG.M13.MSG00027", arg); // 필수값 체크
		}
		
		//주소
		if(StringUtils.isEmpty(orderInfo.getInstBaseAddr())){
			String[] arg = {MessageUtil.getMessage("LAB.M07.LAB00301")}; // 설치주소
			throw new ServiceException("MSG.M13.MSG00027", arg); // 필수값 체크
		}
