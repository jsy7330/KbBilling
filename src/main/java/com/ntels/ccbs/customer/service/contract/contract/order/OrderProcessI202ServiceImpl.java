...
/**
 * <PRE>
 * 1. ClassName: OrderProcessI202ServiceImpl
 * 2. FileName : OrderProcessI202ServiceImpl.java
 * 3. Package  : com.ntels.ccbs.customer.service.contract.contract.order
 * 4. Comment  : IOT 부가서비스 변경
 * 5. 작성자   : JHYun
 ...
 */
@Service
public class OrderProcessI202ServiceImpl extends OrderProcessServiceImpl implements OrderProcessService{
	
    private final Log logger = LogFactory.getLog(getClass());

    private static final String[] SVC_CD = {"SV096"}; //IOT 서비스
	private static final String ORDER_TP = "202"; //오더유형
	...
	public OrderRequestInfoVO createOrder(OrderRequestInfoVO orderInfo)
		...
		logger.debug("########## IOT 202 Create Order START ###########");
		...
		logger.debug("########## IOT 202 Create Order End ###########");
	...
	public OrderRequestInfoVO cancelOrder(OrderRequestInfoVO orderInfo)
		...
		logger.debug("########## IOT 202 Cancel Order START ###########");
		...
		logger.debug("########## IOT 202 Cancel Order END ###########");
	...
	public OrderRequestInfoVO saveOrder(OrderRequestInfoVO orderInfo)
		...
		logger.debug("########## IOT 202 Save Order START ###########");
		...
		logger.debug("########## IOT 202 Save Order END ###########");
		return orderInfo;
	}
	...
	public OrderRequestInfoVO progressOrder(OrderRequestInfoVO orderInfo) throws ServiceException {
		...
		logger.debug("########## IOT 202 Progress Order START ###########");
		...
		logger.debug("########## IOT 202 Progress Order END ###########");
		return orderInfo;
	}
	...
	public void processPreOrderMake(OrderRequestInfoVO orderInfo) throws ServiceException {
		...
		List<Map<String, Object>> addProdList = orderManagementMapper.getAddProdList(orderInfo.getSoId(), (String)baicProdInfo.get("prod_grp"), (String)baicProdInfo.get("prod_cd") , orderInfo.getOrderReqDt(), orderInfo.getLng());
		//사용중인 서비스 구성 정보 조회
