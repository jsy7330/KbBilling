...
public class PaymentAccountInfoVO implements Serializable,CommonVO{

	
	private static final long serialVersionUID = -7844014518025964532L;
	...
	private String billCyclCdNm; /*청구주기*/
	...
	public String toString() {
		...
		builder.append("PaymentAccountInfoVO [soId=");
		builder.append(soId);
		...
		builder.append(useAcntNmYn);
		builder.append(", billCyclCd=");
		builder.append(billCyclCd);
		builder.append(", billCyclCdNm=");
		builder.append(billCyclCdNm);
