...
@Service
public class DistributeDN0002ServiceImpl implements InterfaceProcessService {
	...
	private static final String OP_CODE = "DN0002";
	...
	public ResponseVO processInterface(String svcCode, String opCode, RequestVO request) {
		...
		try{
			...
			deviceList = distributeMapper.getUsimList(orgId, parameter.get("item_id"), parameter.get("imsi"), parameter.get("lng"));
